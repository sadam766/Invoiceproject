...
export const InvoiceTemplate = ({ invoiceData, type }: { invoiceData: InvoiceData, type: 'Original' | 'Copy' }) => {
    ...
    // PAGINATION LOGIC: Split items into chunks to prevent layout shifting
            ...
            {itemChunks.map((chunk, pageIndex) => {
                ...
                return (
                    ...
                    >
                        ...
                        <main className='relative flex-1'>
                            <table className="w-full border-collapse text-[8.5pt]">
                                ...
                                <tbody>
                                    ...
                                    {isLastPage ? (
                                        <>
                                            {/* FILLER TO MAINTAIN LAYOUT POSITION */}
                                            <tr>
                        ...
                        {/* FOOTER SECTION - LOCKED TO LAST PAGE */}
                        {isLastPage ? (
                            <footer className="mt-auto pt-2" style={{ pageBreakInside: 'avoid', display: 'block' }}>
                                {/* NO PO SECTION */}
